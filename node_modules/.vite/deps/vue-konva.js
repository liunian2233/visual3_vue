  ...
  "node_modules/konva/lib/filters/Emboss.js"(exports) {
    ...
    var Emboss = function(imageData) {
      ...
      do {
        ...
        const offsetYOther = (y - 1 + otherY) * w2 * 4;
        let x = w2;
        do {
...
var require_Kaleidoscope = __commonJS({
  "node_modules/konva/lib/filters/Kaleidoscope.js"(exports) {
    ...
    var Kaleidoscope = function(imageData) {
      ...
      let x, y, xoff, i2, r, g, b2, a, srcPos, dstPos;
...
function L(o, t, a, c) {
  ...
  for (let n in a) {
    ...
    if (u && f) {
      ...
      l.slice(0, 7) === "content" && (l = "content" + l.slice(7, 1).toUpperCase() + l.slice(8)), e == null ? void 0 : e.off(l + _, a[n]);
    }
  ...
  for (let n in t) {
    ...
    if (u && f) {
      ...
      s.slice(0, 7) === "content" && (s = "content" + s.slice(7, 1).toUpperCase() + s.slice(8)), t[n] && (e == null ? void 0 : e.off(s + _), e == null ? void 0 : e.on(s + _, t[n]));
    }
    !u && (t[n] !== a[n] || c && t[n] !== (e == null ? void 0 : e.getAttr(n))) && (r = true, d[n] = t[n]);
  }
...
function V(o) {
  ...
  if ((t == null ? void 0 : t.tagName) && a && !c) {
...
function j(o) {
  const t = (e) => !!(e == null ? void 0 : e.hasOwnProperty("component")), a = (e) => Array.isArray(e), c = (e) => t(e) ? [e, ...c(e.children)] : a(e) ? e.flatMap(c) : [];
  return c(o.children);
}
function O(o, t) {
  const a = j(o), c = [];
...
var F = defineComponent({
  ...
  setup(o, { attrs: t, slots: a, expose: c }) {
    ...
    if (!e) return;
    const d = reactive({}), r = ref(null), n = new import_konva.default.Stage({
    ...
    return onMounted(() => {
      ...
      n.destroy();
    }), watch(() => o.config, s, { deep: true }), c({
      getStage: f,
      getNode: u
    }), () => {
      var _a;
      return h("div", { ref: r, style: t == null ? void 0 : t.style }, (_a = a.default) == null ? void 0 : _a.call(a));
    };
  }
});
var G = ".vue-konva-event";
var $ = {
  Group: true,
  Layer: true,
  FastLayer: true,
  ...
  return defineComponent({
    ...
    setup(a, { attrs: c, slots: e, expose: d }) {
      ...
      function l() {
        if (!r) return;
        const v = {};
        for (const m in r == null ? void 0 : r.vnode.props)
      ...
      onMounted(() => {
        var _a;
        const v = (_a = U(r)) == null ? void 0 : _a.__konvaNode;
        v && "add" in v && v.add(u), p(u);
      }), onUnmounted(() => {
        p(u), u.destroy(), u.off(G);
      }), onUpdated(() => {
        l(), O(r.subTree, u);
      }), watch(() => a.config, l, { deep: true }), d({
        getStage: s,
        getNode: f
      });
      ...
      return () => {
        var _a;
        return g ? h("template", {}, (_a = e.default) == null ? void 0 : _a.call(e)) : null;
      };
    }
  });
}
function Y(o, t, a) {
  const c = ref(null), e = ref("loading"), d = (n, u, f) => {
    e.value = "loading";
    const s = new Image();
...
var Z = {
  install: (o, t) => {
    const a = (t == null ? void 0 : t.prefix) || M, c = {
